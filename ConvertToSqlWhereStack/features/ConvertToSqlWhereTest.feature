...
Scenario Outline:轉換 
	...
	| N.EQ. or. N.NQ. or. S.EQ ) and. (S.EQ. and. N.NQ. and. S.NQ. ) and. ( S.NQ. or. N.EQ. or. S.EQ.) | and(or(a:equals(1),not(b:equals(2)),c:equals("3")),and(c:equals("3"),not(b:equals(2)),not(d:equals("4"))),or(not(d:equals("4")),a:equals(1),c:equals("3"))) | ( a = 1 or b != 2 or c = '3' ) and ( c = '3' and b != 2 and d != '4' ) and ( d != '4' or a = 1 or c = '3' ) |
